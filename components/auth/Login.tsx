            ...
            <div className="max-w-md w-full space-y-12 animate-fadeUp z-10 relative">
                ...
                <div className="editorial-card p-10 space-y-8 bg-[#151515]/80 backdrop-blur-md">
                    ...
                    <p className="text-[9px] text-[#888] leading-relaxed px-1">
                        Приемам <Link to="/terms" target="_blank" rel="noopener noreferrer" className="text-[8px] font-normal text-[#968B74] hover:text-[#C4B091] border-b border-[#968B74]/30">Правилата и условията за ползване</Link> и <Link to="/privacy" target="_blank" rel="noopener noreferrer" className="text-[8px] font-normal text-[#968B74] hover:text-[#C4B091] border-b border-[#968B74]/30">Политиката за поверителност</Link>.
                    </p>
