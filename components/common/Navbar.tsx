...
const Navbar: React.FC = () => {
    ...
    return (
        <header className="sticky top-0 z-[100] py-4 md:py-6 border-b border-slate-300 print:hidden bg-[#f9f9f9]/90 backdrop-blur-md px-4 md:px-8 shadow-sm transition-all duration-300">
            <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between items-center md:items-end gap-6">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-center md:items-end w-full md:w-auto">
                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                        <button
                            ...
                            className="bg-amber-900 text-white px-5 py-2 text-[9px] font-black uppercase tracking-[0.2em] hover:bg-amber-950 transition-all shadow-sm"
                        >
                            ВИДЕО ОДИТ
                        </button>
                        <button
                                ...
                                {showUserMenu && (
                                    <div className="absolute right-0 top-full mt-2 w-56 bg-white p-3 shadow-2xl border-2 border-slate-200 z-50 animate-fadeIn">
                                        <div className="space-y-2">
                                            ...
                                            {/* Архив */}
                                            <button
                                                onClick={() => { navigate('/archive'); setShowUserMenu(false); }}
