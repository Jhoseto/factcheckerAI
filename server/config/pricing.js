 ...
 * ====================================================
 * CommonJS версия на config/pricingConfig.ts за използване в server/
 * Единственото място за промяна на цените на сървъра.
 */
...
const FIXED_PRICES = {
  ...
  socialPost: 8,          // Анализ на пост (FB / Twitter / TikTok)
