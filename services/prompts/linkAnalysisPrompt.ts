...
` : ''}
КРИТИЧНО ВАЖНО:
1. **ОСНОВЕН ИСТОЧНИК**: ${hasContent ? 'Ползвай ТЕКСТА НА СТАТИЯТА по-горе като основен источник. Анализирай САМО тази статия — не измисляй, не заменяй с друга.' : 'Използвай URL Context за да прочетеш статията директно. Ако не е достъпна — търси в Google по URL и по заглавие за пълния текст.'}
