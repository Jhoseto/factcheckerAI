...
` : ''}
КРИТИЧНО ВАЖНО:
1. **ВЕРИФИКАЦИЯ КЪМ МОМЕНТА (КРИТИЧНО)**: Днешната дата е ${currentDate}. Ти ТРЯБВА да използваш тази дата като абсолютна референтна точка за "сега". Първо провери чрез Google Search дали анализираната статия и събитията в нея не са актуални новини от последните дни. АКТИВНО ИЗПОЛЗВАЙ ИНСТРУМЕНТА googleSearch ЗА ВСЯКО ТВЪРДЕНИЕ. Ако има съвпадение, приоритизирай актуалната информация от новините пред своята предварително обучена памет. Всичко — имена, длъжности, факти, числа, цитати — трябва да се свери с актуалното състояние на нещата ДНЕС. КАТЕГОРИЧНО СЕ ЗАБРАНЯВА да игнорираш нови новини от последните 7 дни (напр. политически промени, смърт на световни лидери или икономически сривове), дори ако статията е стара.
...
- Имена, длъжности, факти, числа — ВСИЧКО трябва да се свери с актуалното състояние на нещата ДНЕС съгласно най-новите налични факти и Google Search. Приоритизирай актуалната реалност пред своята вътрешна памет.
...
Върни САМО валиден JSON (без Markdown обвивка):
{
  ...
  "manipulationTechniques": [
    {
      "technique": "Име на техниката на български, следвано от оригиналното английско наименование в скоби (напр. 'Емоционално зареждане (Emotional loading)', 'Cherry-picking', 'Апел към авторитета (Appeal to Authority)')",
  ...
  "finalInvestigativeReport": "Напиши РАЗСЛЕДВАЩ ДОКЛАД на DCGE за тази статия — не официален бюрократичен текст, а живо, критично разследване с CHARACTER и ДУША. ПИПАЙ ЗА КАЧЕСТВО, НЕ ЗА КОЛИЧЕСТВО. Пиши ЗА БЪЛГАРИ: родният контекст, здравият разум на обикновения Bulgarian, конкретни последствия за хората тук.\\n\\nАДАПТИВЕН СТИЛ — прецени темата на статията и избери ЕДИН глас:\\n• Политика / власт / корупция → Кеворк Кеворкян: безпощаден сарказъм управляван от факти, умни метафори. Зове нещата с истинските им имена.\\n• Медии / шоу / таблоид / инфлуенсъри → Иво Сиромахов: освободен, директен, остроумен. Удря там където боли. Нула дипломация.\\n• Общество / морал / психология / религия → Мартин Карбовски: тежкотонажен литературен език, метафори, мъдрост с нотка тъга. Думи като пирони.\\n• Икономика / бизнес / наука → Авторитетен с характер — ерудиция и мнение, без жаргон.\\n\\nОБЩИ ПРАВИЛА:\\n— Богата БЪЛГАРСКА ЛЕКСИКА — живи думи, не преводи. Разговорни или литературни — зависи от контекста.\\n— Ритъм: кратък удар → разгърнат параграф → кратък удар.\\n— Метафорите са задължителни — поне 3-4 добри образа.\\n— НЕ ПИШИ КАТО МАШИНА: никакво 'Анализът установи', никакво 'Системата откри'.\\n— Препращай конкретно към твърдения и манипулации.\\n\\nСТРУКТУРА (задължителна):\\n# [ЗАГЛАВИЕ — ПРИСЪДА В ЕДНО РЯЗКО ИЗРЕЧЕНИЕ]\\n\\n## ПРИСЪДАТА\\nЕдно изречение. Без политес. Без смекчаване.\\n\\n## КАК РАБОТИ ТАЗИ МАНИПУЛАЦИЯ\\nМЕХАНИЗМЪТ — стъпка по стъпка. Как точно се прокарва идеята. Препраща конкретно. Ярки примери.\\n\\n## КАКВО НЕ ВИ КАЗВАТ\\nПропуснатото, замълчаното, пречупено през погледа на обикновения читател.\\n\\n## КОЙ ПЕЧЕЛИ ОТ ТОВА\\nСтратегическото намерение — ясно и директно. Без дипломация.\\n\\n## ЗАКЛЮЧЕНИЕ\\nФинална присъда. Конкретен съвет. Сякаш съветваш близък приятел.\\n\\nDCGE Report • ${reportDate}"
}`;
};
