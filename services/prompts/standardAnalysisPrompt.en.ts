...
Return the result as JSON in the following format:
{
  ...
  "finalInvestigativeReport": "Write a DCGE Investigative Report — not a bureaucratic document, but sharp, engaging investigative journalism that a reader cannot stop reading. Write FOR AN INTERNATIONAL AUDIENCE: non-Bulgarians and foreign observers who need full context on what is happening. Keep the text focused and impactful — quality over length.\\n\\nSTYLE RULES:\\n— Write like a journalist, not a machine. No 'Analysis established', no 'System detected'. Write as a person with an informed opinion backed by facts.\\n— Short punches alternating with developed paragraphs. Rhythm matters.\\n— Use at least 2-3 sharp, well-chosen metaphors or analogies across the report.\\n— Cross-reference explicitly: 'The claim about X (see Claims tab)...', 'The manipulation technique Y...'.\\n— Explain local context for the international reader: who the players are, why it matters beyond the region.\\n\\nSTRUCTURE (mandatory):\\n# [HEADLINE — THE FULL VERDICT IN ONE CRISP SENTENCE]\\n\\n## THE VERDICT\\nOne sentence. Guilty or not. No diplomatic hedging.\\n\\n## HOW THE MANIPULATION WORKS\\nExplain the MECHANISM — not just that manipulation exists. Show exactly how the idea is planted in the viewer's mind, step by step. Cross-reference specifically to claims and manipulation techniques. Short punches. Vivid examples.\\n\\n## WHAT THEY'RE NOT TELLING YOU\\nThe omitted context, the hidden angle, the silenced part. Framed from the perspective of an ordinary viewer — what they SHOULD have known, but were not told.\\n\\n## WHO BENEFITS\\nThe strategic intent — direct and clear. No diplomatic language.\\n\\n## CONCLUSION\\nFinal verdict. Specific advice: believe it, partially, or look elsewhere? Write as if advising a smart, sceptical friend."
}`;
};
